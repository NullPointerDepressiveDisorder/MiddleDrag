...
final class GestureRecognizerTests: XCTestCase {
    ...
    func testContactSizeFilter_DisabledAcceptsAllContacts() {
        ...
        // The incidental-contact classifier would honestly treat three uniformly
        // palm-pressure contacts as a resting hand; this test is about the legacy
        // size filter, so disable the classifier too.
        recognizer.configuration.incidentalFilterEnabled = false
